...
# Подключение к базе данных itmo_db
...
print_table_data('borrowers', cur)
print_table_data('individuals', cur)
print_table_data('loans', cur)
print_table_data('organization_loans', cur)
